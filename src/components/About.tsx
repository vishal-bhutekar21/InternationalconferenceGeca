                ...
                <div style={{
                    ...
                    >
                        ...
                        <p style={{ fontSize: '1.1rem', lineHeight: 1.8, color: 'var(--color-text-muted)', marginBottom: '1.5rem' }}>
                            The International Conference on Artificial Intelligence (AI) for Sustainable Growth (ICAISG2026) brings together leading academicians, scientists, researchers, and scholars to exchange and share their experiences and research results on all aspects of Artificial Intelligence.
                        </p>
