...
const GalleryPage = () => {
    ...
    const categories = ['All', 'ICAISG 2026', 'Legacy ICAISG-26', 'Keynote Speakers', 'Networking'];
    ...
    const items = [
        ...
        { id: 4, category: 'Legacy ICAISG-26', image: 'https://images.unsplash.com/photo-1540575861501-7ce058a877c3?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80', title: 'Inauguration 2026' },
