        ...
        <main style={{ paddingTop: '100px', backgroundColor: 'var(--color-bg-light)', minHeight: '100vh', paddingBottom: '6rem' }}>
            ...
            <section style={{ padding: '6rem 0 4rem', backgroundColor: 'var(--color-white)', borderBottom: '1px solid var(--color-border)' }}>
                <div className="container" style={{ textAlign: 'center' }}>
                    ...
                    <h1 style={{ fontSize: 'clamp(2.5rem, 8vw, 4.5rem)', fontWeight: 900, marginBottom: '1.5rem', color: 'var(--color-primary)' }}>
                        Distinguished Speakers
                    </h1>
                    <p style={{ maxWidth: '700px', margin: '0 auto', color: 'var(--color-text-muted)', fontSize: '1.1rem', lineHeight: 1.6 }}>
            ...
            <section style={{ padding: '6rem 0' }}>
                <div className="container">
                    ...
                    }} className="keynotes-flex-container">
                        {keynotes.map((s, i) => (
                            <motion.div
                                key={i}
                                whileHover={{ y: -10 }}
            ...
            <section style={{ padding: '2rem 0 6rem' }}>
                <div className="container">
                    ...
                    <div style={{
                        ...
                        marginBottom: '4rem',
                        justifyContent: 'center'
                    }} className="chairs-flex-container">
                        {chairs.map((c, i) => (
                            <div key={i} style={{
                                backgroundColor: 'white',
                                padding: '1.5rem 2rem',
